// This is not my code. This code is from the research paper and github: "MGG: Accelerating Graph Neural Networks with Fine-Grained Intra-Kernel Communication-Computation 
